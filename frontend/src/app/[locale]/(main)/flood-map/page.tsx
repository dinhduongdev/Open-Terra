...
import FloodReportForm, {
  FloodReport,
} from "@/components/common/FloodReportForm";
...
import {
  getFloodReports,
  submitFloodReport,
} from "@/services/floodReportService";
import {
...
export default function FloodMapPage() {
  ...
  const handleSubmitReport = async (
    report: Omit<FloodReport, "id" | "timestamp" | "status">
  ) => {
    try {
        ...
        <div className="mb-6">
          <div className="flex items-start justify-between gap-4">
            <div>
              ...
              <p className="text-gray-600">{tFlood("subtitle")}</p>
            </div>
            <button
